...
class PostgreSQLAdapter(SqlAlchemySyncAdapter):
    family = "postgresql"
    ...
    def _assemble_schema(
        ...
        *,
        ...
        for col in all_columns:
            schema_name = str(col["table_schema"] or "public")
        ...
        for pk in all_primary_keys:
            key = (str(pk["schema_name"] or "public"), str(pk["table_name"]))
        ...
        for idx in all_indexes:
            key = (str(idx["schema_name"] or "public"), str(idx["table_name"]))
        ...
        for stat in all_stats:
            key = (str(stat["schema_name"] or "public"), str(stat["table_name"]))
            stats_by_table[key] = {
        ...
        for fk in all_foreign_keys:
            key = (str(fk["schema_name"] or "public"), str(fk["table_name"]))
