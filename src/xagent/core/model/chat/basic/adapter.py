...
def create_base_llm(model: ModelConfig) -> BaseLLM:
    ...
    #     )
        ...
        raise TypeError(
            f"Unsupported LLM model type: {model.model_provider}. "
            f"Only 'openai' or OpenAI-compatible providers are supported."
        )
