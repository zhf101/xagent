...
class KingbaseAdapter(SqlAlchemySyncAdapter):
    family = "postgresql"
    supported_types = ("kingbase",)
    ...
    def build_sqlalchemy_url(self) -> URL:
        return URL.create(
            ...
            port=self.config.port or 54321,
        ...
        with engine.connect() as conn:
            ...
            all_columns = conn.execute(
                text(
                    ...
                    WHERE c.table_schema NOT IN ('pg_catalog', 'information_schema', 'pg_toast', 'pg_bitmapindex', 'pg_aoseg', 'gp_toolkit')
            ...
            all_primary_keys = conn.execute(
                text(
                    ...
                    WHERE i.indisprimary
                      AND n.nspname NOT IN ('pg_catalog', 'information_schema', 'pg_toast', 'pg_bitmapindex', 'pg_aoseg', 'gp_toolkit')
