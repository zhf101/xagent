...
export const themes: Record<string, Theme> = {
  ...
  light: {
    ...
    colors: {
      ...
      foreground: '0 0% 13%',         // #1f1f1f 主文字
      card: '0 0% 100%',
      cardForeground: '0 0% 13%',
      popover: '0 0% 100%',
      popoverForeground: '0 0% 13%',
      primary: '3 70% 52%',           // #d33b32 红色
      primaryForeground: '0 0% 100%',
      secondary: '0 0% 97%',          // #f7f7f7 很浅灰
      secondaryForeground: '0 0% 40%',
      muted: '0 0% 98%',              // #fafafa 极浅灰
      mutedForeground: '0 0% 50%',    // #808080
      accent: '0 0% 98%',
      accentForeground: '0 0% 13%',
      destructive: '0 84.2% 60.2%',
      destructiveForeground: '0 0% 98%',
      border: '0 0% 92%',             // #ececec
      input: '0 0% 92%',
      ring: '3 70% 52%',
      // Extended colors
