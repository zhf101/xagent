...
import { getVannaKnowledgeBase } from "../shared/vanna-api"
  ...
  const navItems: NavItem[] = [
    {
      ...
      label: "表结构信息",
      icon: Database,
      href: `/gdp/vanna/knowledge-bases/${id}/facts`,
      matchPrefixes: [`/gdp/vanna/knowledge-bases/${id}/facts`, `/gdp/vanna/knowledge-bases/${id}/harvest`],
    },
    {
      id: "question_sql",
      label: "SQL 问答对",
      icon: MessageSquare,
      href: `/gdp/vanna/knowledge-bases/${id}/training/question-sql`,
      matchPrefixes: [`/gdp/vanna/knowledge-bases/${id}/training/question-sql`],
    },
    {
      id: "documentation",
      label: "SQL 知识文档",
      icon: FileCode2,
      href: `/gdp/vanna/knowledge-bases/${id}/training/documentation`,
      matchPrefixes: [`/gdp/vanna/knowledge-bases/${id}/training/documentation`],
    },
    {
      id: "assets",
      label: "SQL 资产",
      icon: Sparkles,
      href: `/gdp/vanna/knowledge-bases/${id}/assets`,
      matchPrefixes: [`/gdp/vanna/knowledge-bases/${id}/assets`],
    },
    {
      id: "train_method",
      label: "Train 方法",
      icon: Braces,
      href: `/gdp/vanna/knowledge-bases/${id}/train`,
      matchPrefixes: [`/gdp/vanna/knowledge-bases/${id}/train`],
    },
    {
      id: "runs",
      label: "Ask 记录",
      icon: History,
      href: `/gdp/vanna/knowledge-bases/${id}/runs`,
      matchPrefixes: [`/gdp/vanna/knowledge-bases/${id}/runs`],
    },
  ]
        ...
        <div className="h-16 px-8 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Button 
              ...
              onClick={() => router.push("/gdp/vanna/knowledge-bases")}
            >
          ...
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" className="rounded-full h-9 px-6 text-xs font-bold gap-2 shadow-lg shadow-primary/20" onClick={() => router.push(`/gdp/vanna/knowledge-bases/${id}/harvest`)}>
