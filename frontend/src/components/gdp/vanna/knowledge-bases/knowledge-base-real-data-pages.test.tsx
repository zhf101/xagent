...
describe("Vanna real-data pages", () => {
  ...
  it("documentation view can stay empty and still route to create documentation", async () => {
    ...
    expect(pushMock).toHaveBeenCalledWith("/gdp/vanna/knowledge-bases/7/training/documentation/new")
    expect(
  ...
  it("train method view renders backend training paths and shortcuts", async () => {
    ...
    expect(pushMock).toHaveBeenCalledWith("/gdp/vanna/knowledge-bases/7/training/question-sql/new")
  })
