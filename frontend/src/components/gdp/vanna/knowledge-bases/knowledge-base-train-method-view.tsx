    ...
    return [
      {
        ...
        actionHref: `/gdp/vanna/knowledge-bases/${kbId}/training/question-sql/new`,
        icon: MessageSquare,
      },
      {
        title: "文档知识训练",
        ...
        actionLabel: "去填写文档知识",
        actionHref: `/gdp/vanna/knowledge-bases/${kbId}/training/documentation/new`,
        icon: BookOpen,
      },
      {
        title: "结构摘要训练",
        ...
        actionHref: `/gdp/vanna/knowledge-bases/${kbId}/harvest`,
        icon: Database,
      },
    ]
  }, [kbId])
