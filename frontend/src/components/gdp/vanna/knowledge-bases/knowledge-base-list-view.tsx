  ...
  return (
    <div className="flex h-screen w-full flex-col overflow-hidden bg-zinc-50/50 text-foreground">
      <header className="flex h-16 shrink-0 items-center justify-between border-b bg-background px-8 shadow-sm">
        ...
        <div className="flex items-center gap-3">
          <Button variant="outline" onClick={() => router.push("/gdp/vanna/sql/datasources")}>
                  ...
                  {filteredKnowledgeBases.length === 0 ? (
                    ...
                    filteredKnowledgeBases.map(item => (
                      <TableRow
                        ...
                        onClick={() => router.push(`/gdp/vanna/knowledge-bases/${item.id}/facts`)}
                      >
                        <TableCell>
                        ...
                        <TableCell className="text-right">
                          <Button
                            ...
                            onClick={(event) => {
                              ...
                              router.push(`/gdp/vanna/knowledge-bases/${item.id}/facts`)
                            }}
                          >
                            查看表结构
                          </Button>
